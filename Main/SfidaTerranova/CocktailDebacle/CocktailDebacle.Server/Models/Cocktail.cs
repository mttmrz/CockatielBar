...
namespace CocktailDebacle.Server.Models
{
    public class Cocktail
    {
        ...
        public int UserIdCocktail { get; set; } // id utente che ha creato il cocktail in questo caso null o empty perchè gia un cocktail esistente di default
        ...
        public ICollection<User> UserLikes { get; set; } = new List<User>(); // Collezione di utenti che hanno messo like al cocktail
